...
LABELS = ["あんみつ", "杏仁豆腐", "どら焼き", "いちご大福", "みたらし団子", "おはぎ", "わらび餅", "ようかん"]
CALORIES = [209, 90, 170, 148, 158, 175, 169, 230]
...
model.load_weights('model\dezato\dezato_photos-model.hdf5')
...
def check_photo_dezato(path, number):
